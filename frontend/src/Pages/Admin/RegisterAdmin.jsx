...
const Register = () => {
  ...
  return (
    <div className="max-w-lg mx-auto mt-8 p-4">
      ...
      <br />
      <form className="bg-dark shadow-lg p-50" onSubmit={(e) => {e.preventDefault(); RegisterAdmin() }}>
        ...
        <h6 class="mt-2 text-sm text-gray-500 dark:text-gray-400">Already Have an account ?
          <Link to={'/LogAdmin'}>
          <span className='font-medium text-blue-600 hover:underline dark:text-blue-500'> Log In</span> 
          </Link>
          </h6>
      </form>
    </div>
